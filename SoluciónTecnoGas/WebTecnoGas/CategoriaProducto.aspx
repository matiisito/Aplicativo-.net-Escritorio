<%@ Page Title="" Language="C#" MasterPageFile="~/TecnoGasMP.Master" AutoEventWireup="true" CodeBehind="CategoriaProducto.aspx.cs" Inherits="WebTecnoGas.Formulario_web12" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="cphDiv3" runat="server">
        ...
        <tr>
            ...
            <td class="textos">
                ...
                <asp:TextBox ID="txtNombre" runat="server" style="height: 22px" width="177px" 
                    CssClass="textboxes" MaxLength="50"></asp:TextBox>
            </td>
            <td class="textos">
                <asp:RequiredFieldValidator ID="rfvNombre" runat="server" BorderStyle="Outset" 
                    ...
                    SetFocusOnError="True" CssClass="style2" Width="115px" 
    ...
    <tr>
    <td>
    <asp:GridView ID="gvCategoriaProducto" runat="server" BorderStyle="None" 
        ...
        AutoGenerateColumns="false" DataKeyNames="ID" style="text-align: left" 
            onrowcommand="gvCategoriaProducto_RowCommand" CssClass="textos">
        <Columns>
            <asp:TemplateField>
                <ItemTemplate>
