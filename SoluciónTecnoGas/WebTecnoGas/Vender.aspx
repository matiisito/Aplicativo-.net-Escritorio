<%@ Page Title="" Language="C#" MasterPageFile="~/TecnoGasMP.Master" AutoEventWireup="true" CodeBehind="Vender.aspx.cs" Inherits="WebTecnoGas.Formulario_web112" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="cphDiv3" runat="server">
    <table class="center">
        <tr>
            <td align="center">
                <asp:LinkButton ID="lbtnCombustibles" CssClass="botonesMenu" runat="server" 
                    PostBackUrl="~/Venta.aspx">Venta</asp:LinkButton>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td align="center">
                <asp:LinkButton ID="lbtnNotaDeCredito" CssClass="botonesMenu" runat="server" 
                    PostBackUrl="~/NotaDeCredito.aspx">Nota de crédito</asp:LinkButton>
            </td>
        </tr>
        </table>
</asp:Content>
...
<asp:Content ID="Content8" runat="server" contentplaceholderid="cphDiv2">
    <table style="width:100%;">
        <tr>
            <td>
